...
$code = generateRandNumberVerificationCode();

function generateRandNumberVerificationCodeImg($code = '$code',$width = 129,$height = 38)
{
    ...
    //验证码图片保存路径，文件名称
    $file_name = ROOT_PATH.'/upload/ver_code_img/randimg_id_'.'1'.'.png';
    //域名返回
    $domain_name = ROOT_PATH.'/upload/ver_code_img/randimg_id_'.'1'.'.png';
...
$aa=generateRandNumberVerificationCodeImg($code);
