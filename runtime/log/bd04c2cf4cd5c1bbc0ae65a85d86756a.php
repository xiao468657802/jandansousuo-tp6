<?php /*a:1:{s:46:"/www/wwwroot/tp66.cn/tp/view/links/output.html";i:1624937474;}*/ ?>
...
<!--        <li>1</li>-->
<!--        <li><?php echo htmlentities($obj['id']); ?></li>-->
<!--        <li>"<?php echo htmlentities($obj['links']); ?>"</li>-->
<!--        <li><?php echo htmlentities($obj['xlinksico']); ?></li>-->
<!--        <li><?php echo htmlentities($obj['linkname']); ?></li>-->
<!--        <?php endforeach; ?>-->
<!--        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ss_links): $mod = ($i % 2 );++$i;?>-->
<!--        <li>1</li>-->
<!--        <li><?php echo htmlentities($ss_links->id); ?></li>-->
<!--        <li><?php echo htmlentities($ss_links->links); ?></li>-->
<!--        <li><?php echo htmlentities($ss_links->xlinksico); ?></li>-->
<!--        <li><?php echo htmlentities($ss_links->linkname); ?></li>-->
